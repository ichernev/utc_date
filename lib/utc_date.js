...
(function (root, factory) {
    ...
    UTCDate.fromUnixMs = function (unix_ms) {
        var d = new Date(unix_ms);
        return new UTCDate(d.getUTCFullYear(), d.getUTCMonth(),
    ...
    UTCDate.fn.setUTCDate = function (date) {
        ...
        // Make sure setUTCMonth doesn't trigger an infinite recursion.
        this.d = 1;
        if (diff !== 0) {
