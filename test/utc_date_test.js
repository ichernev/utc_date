...
describe("utc_date", function() {
    ...
    describe("daysInMonth", function() {
        it("defaults to current month", function () {
            ...
            d.setUTCMonth(1);
            d.daysInMonth().should.equal(29); // Feb, leap year

            d.setUTCMonth(2);
            d.daysInMonth().should.equal(31); // Mar

            d.setUTCMonth(3);
            d.daysInMonth().should.equal(30); // Apr

            d.setUTCMonth(4);
            d.daysInMonth().should.equal(31); // May

            d.setUTCMonth(5);
            d.daysInMonth().should.equal(30); // Jun

            d.setUTCMonth(6);
            d.daysInMonth().should.equal(31); // Jul

            d.setUTCMonth(7);
            d.daysInMonth().should.equal(31); // Aug

            d.setUTCMonth(8);
            d.daysInMonth().should.equal(30); // Sep

            d.setUTCMonth(9);
            d.daysInMonth().should.equal(31); // Oct

            d.setUTCMonth(10);
            d.daysInMonth().should.equal(30); // Nov

            d.setUTCMonth(11);
            d.daysInMonth().should.equal(31); // Dec
    ...
    describe("localtime setters", function () {
        describe("far from DST, full hour offset", function () {
            ...
            it("handles years", function() {
                ...
                d.setFullYear(1999);
                d.getFullYear().should.equal(1999);
                d.setMonth(11);
